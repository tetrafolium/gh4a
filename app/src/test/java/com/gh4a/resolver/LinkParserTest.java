...
public class LinkParserTest {
  ...
  public void linkToGist_withUserInPath__opensGistActivity() throws Exception {
    LinkParser.ParseResult result =
        parseLink("https://gist.github.com/user/gistId");
    assertRedirectsTo(result, GistActivity.class);
    Bundle extras = result.intent.getExtras();
    assertThat("Extras are missing", extras, is(notNullValue()));
    assertThat("Gist id is incorrect", extras.getString("id"), is("gistId"));
  ...
  public void reservedPaths__openBrowser() {
    String[] reservedPaths = {
        "apps",     "integrations", "login",       "logout",   "marketplace",
        "sessions", "settings",     "updates",     "support",  "contact",
        "about",    "personal",     "open-source", "business", "site",
        "security", "features"};
  ...
  public void exploreLink__opensTrendingActivity() throws Exception {
    assertRedirectsTo(parseLink("https://github.com/explore"),
                      TrendingActivity.class);
  }

  @Test
  public void blogLink__opensBlogListActivity() throws Exception {
    assertRedirectsTo(parseLink("https://github.com/blog"),
                      BlogListActivity.class);
    assertRedirectsTo(parseLink("https://blog.github.com"),
                      BlogListActivity.class);
  }
  ...
  public void organizationLink__opensUserActivity() throws Exception {
    LinkParser.ParseResult result =
        parseLink("https://github.com/orgs/android");
    assertRedirectsTo(result, UserActivity.class);
    Bundle extras = result.intent.getExtras();
    assertThat("Extras are missing", extras, is(notNullValue()));
    assertThat("Organization name is incorrect", extras.getString("login"),
               is("android"));
  }
  ...
  @Test
  public void
  organisationLink_leadingToMembers__opensOrganizationMemberListActivity()
      throws Exception {
    LinkParser.ParseResult result =
        parseLink("https://github.com/orgs/android/people");
  ...
  public void userLink__opensUserActivity() throws Exception {
    ...
    Bundle extras = result.intent.getExtras();
    assertThat("Extras are missing", extras, is(notNullValue()));
    assertThat("User name is incorrect", extras.getString("login"),
               is("slapperwan"));
  }
  ...
  public void userLink_withRepositoriesTab__loadsUserRepos() throws Exception {
    LinkParser.ParseResult result =
        parseLink("https://github.com/slapperwan?tab=repositories");
    UserReposLoadTask loadTask =
        assertThatLoadTaskIs(result.loadTask, UserReposLoadTask.class);
    assertThat("Loading starred repos is set to true", loadTask.mShowStars,
               is(false));
  ...
  public void userLink_withStarsTab__loadsUserStarredRepos() throws Exception {
    LinkParser.ParseResult result =
        parseLink("https://github.com/slapperwan?tab=stars");
    UserReposLoadTask loadTask =
        assertThatLoadTaskIs(result.loadTask, UserReposLoadTask.class);
    assertThat("Loading starred repos is set to false", loadTask.mShowStars,
               is(true));
    assertThat("User name is incorrect", loadTask.mUserLogin, is("slapperwan"));
  }
  ...
  public void userLink_withFollowersTab__loadsUserFollowers() throws Exception {
    LinkParser.ParseResult result =
        parseLink("https://github.com/slapperwan?tab=followers");
    UserFollowersLoadTask loadTask =
        assertThatLoadTaskIs(result.loadTask, UserFollowersLoadTask.class);
    assertThat("Loading followers is set to false", loadTask.mShowFollowers,
               is(true));
    assertThat("User name is incorrect", loadTask.mUserLogin, is("slapperwan"));
  }
  ...
  public void userLink_withFollowingTab__loadsUserFollows() throws Exception {
    LinkParser.ParseResult result =
        parseLink("https://github.com/slapperwan?tab=following");
    UserFollowersLoadTask loadTask =
        assertThatLoadTaskIs(result.loadTask, UserFollowersLoadTask.class);
    assertThat("Loading followers is set to true", loadTask.mShowFollowers,
               is(false));
    assertThat("User name is incorrect", loadTask.mUserLogin, is("slapperwan"));
  }
  ...
  public void userLink_withUnknownTab__opensUserActivity() throws Exception {
    LinkParser.ParseResult result =
        parseLink("https://github.com/slapperwan?tab=unknown");
    assertRedirectsTo(result, UserActivity.class);
    Bundle extras = result.intent.getExtras();
    assertThat("Extras are missing", extras, is(notNullValue()));
    assertThat("User name is incorrect", extras.getString("login"),
  ...
  public void repositoryLink__opensRepositoryActivity() throws Exception {
    LinkParser.ParseResult result =
        parseLink("https://github.com/slapperwan/gh4a");
    assertRedirectsTo(result, RepositoryActivity.class);
    Bundle extras = result.intent.getExtras();
    assertThat("Extras are missing", extras, is(notNullValue()));
    assertThat("User name is incorrect", extras.getString("owner"),
               is("slapperwan"));
    assertThat("Repo name is incorrect", extras.getString("repo"), is("gh4a"));
    assertThat("Ref is set", extras.getString("ref"), is(nullValue()));
    assertThat("Initial path is set", extras.getString("initial_path"),
               is(nullValue()));
    assertThat("Initial page did not lead to overview",
               extras.getInt("initial_page"),
  ...
  public void releasesLink__opensReleaseListActivity() throws Exception {
    LinkParser.ParseResult result =
        parseLink("https://github.com/slapperwan/gh4a/releases");
  ...
  public void releaseLink_withTagId__loadsRelease() throws Exception {
    ...
    ReleaseLoadTask loadTask =
        assertThatLoadTaskIs(result.loadTask, ReleaseLoadTask.class);
  ...
  public void issuesLink__opensIssueListActivity() throws Exception {
    LinkParser.ParseResult result =
        parseLink("https://github.com/slapperwan/gh4a/issues");
    ...
    assertThat("User name is incorrect", extras.getString("owner"),
               is("slapperwan"));
    assertThat("Repo name is incorrect", extras.getString("repo"), is("gh4a"));
    assertThat("Issue type is pull request",
               extras.getBoolean("is_pull_request"), is(false));
  }

  @Test
  public void newIssueLink__opensIssueEditActivity() throws Exception {
    LinkParser.ParseResult result =
        parseLink("https://github.com/slapperwan/gh4a/issues/new");
    ...
    assertThat("User name is incorrect", extras.getString("owner"),
               is("slapperwan"));
    assertThat("Repo name is incorrect", extras.getString("repo"), is("gh4a"));
    assertThat("Issue to edit is set", extras.getParcelable("issue"),
               is(nullValue()));
  }
  ...
  public void issueLink__opensIssueActivity() throws Exception {
    LinkParser.ParseResult result =
        parseLink("https://github.com/slapperwan/gh4a/issues/42");
  ...
  public void issueLink_withIncorrectNumber__opensBrowser() throws Exception {
    LinkParser.ParseResult result =
        parseLink("https://github.com/slapperwan/gh4a/issues/34no");
    assertRedirectsToBrowser(result);
  }

  @Test
  public void
  issueLink_withCommentMarker__opensIssueActivity_andHasCommentMarker()
      throws Exception {
    LinkParser.ParseResult result = parseLink(
        "https://github.com/slapperwan/gh4a/issues/42#issuecomment-1234");
    assertRedirectsTo(result, IssueActivity.class);
    Bundle extras = result.intent.getExtras();
    assertThat("Extras are missing", extras, is(notNullValue()));
    assertThat("User name is incorrect", extras.getString("owner"),
    ...
    assertThat("Repo name is incorrect", extras.getString("repo"), is("gh4a"));
    assertThat("Issue number is incorrect", extras.getInt("number"), is(42));
    IntentUtils.InitialCommentMarker commentMarker =
        extras.getParcelable("initial_comment");
  ...
  public void issueLink_withIncorrectCommentMarker_opensIssueActivity()
      throws Exception {
    LinkParser.ParseResult result = parseLink(
        "https://github.com/slapperwan/gh4a/issues/42#issuecomment-A3");
    assertRedirectsTo(result, IssueActivity.class);
    Bundle extras = result.intent.getExtras();
    assertThat("User name is incorrect", extras.getString("owner"),
               is("slapperwan"));
  ...
  public void pullRequestsLink__opensIssueListActivity() throws Exception {
    LinkParser.ParseResult result =
        parseLink("https://github.com/slapperwan/gh4a/pulls");
    assertRedirectsTo(result, IssueListActivity.class);
    Bundle extras = result.intent.getExtras();
    assertThat("Extras are missing", extras, is(notNullValue()));
    assertThat("User name is incorrect", extras.getString("owner"),
               is("slapperwan"));
    assertThat("Repo name is incorrect", extras.getString("repo"), is("gh4a"));
    assertThat("Issue type is not pull request",
               extras.getBoolean("is_pull_request"), is(true));
  }

  @Test
  public void wikiLink__opensWikiListActivity() throws Exception {
    LinkParser.ParseResult result =
        parseLink("https://github.com/slapperwan/gh4a/wiki");
    ...
    assertThat("User name is incorrect", extras.getString("owner"),
               is("slapperwan"));
    assertThat("Repo name is incorrect", extras.getString("repo"), is("gh4a"));
    assertThat("Initial page is set", extras.getString("initial_page"),
               is(nullValue()));
  }

  @Test
  public void pullRequestLink_withoutId__opensBrowser() throws Exception {
    assertRedirectsToBrowser(
        parseLink("https://github.com/slapperwan/gh4a/pull"));
  }

  @Test
  public void pullRequestLink_withInvalidId__opensBrowser() throws Exception {
    assertRedirectsToBrowser(
        parseLink("https://github.com/slapperwan/gh4a/pull/-1"));
    assertRedirectsToBrowser(
        parseLink("https://github.com/slapperwan/gh4a/pull/fwbi"));
    assertRedirectsToBrowser(
        parseLink("https://github.com/slapperwan/gh4a/pull/0"));
  }

  @Test
  public void pullRequestLink__opensPullRequestActivity() throws Exception {
    LinkParser.ParseResult result =
        parseLink("https://github.com/slapperwan/gh4a/pull/12");
    ...
    assertThat("User name is incorrect", extras.getString("owner"),
               is("slapperwan"));
    assertThat("Repo name is incorrect", extras.getString("repo"), is("gh4a"));
    assertThat("Pull request number is incorrect", extras.getInt("number"),
               is(12));
  ...
  @Test
  public void
  pullRequestLink_withCommentMarker__opensPullRequestActivity_andHasCommentMarker()
      throws Exception {
    LinkParser.ParseResult result = parseLink(
        "https://github.com/slapperwan/gh4a/pull/14#issuecomment-7546");
    assertRedirectsTo(result, PullRequestActivity.class);
    Bundle extras = result.intent.getExtras();
    assertThat("Extras are missing", extras, is(notNullValue()));
    assertThat("User name is incorrect", extras.getString("owner"),
  ...
  @Test
  public void
  pullRequestLink_withDiffMarker_andInvalidNumber__opensPullRequest()
      throws Exception {
    LinkParser.ParseResult result =
        parseLink("https://github.com/slapperwan/gh4a/pull/665/files"
  ...
  public void pullRequestReviewLink__loadsReview() throws Exception {
    LinkParser.ParseResult result = parseLink(
        "https://github.com/slapperwan/gh4a/pull/665#pullrequestreview-59822171");
    PullRequestReviewLoadTask loadTask =
        assertThatLoadTaskIs(result.loadTask, PullRequestReviewLoadTask.class);
    assertThat("User name is incorrect", loadTask.mRepoOwner, is("slapperwan"));
    assertThat("Repo name is incorrect", loadTask.mRepoName, is("gh4a"));
    assertThat("Pull request number is incorrect", loadTask.mPullRequestNumber,
               is(665));
    assertThat("Comment marker is missing", loadTask.mMarker,
               is(notNullValue()));
    assertThat("Comment id is incorrect", loadTask.mMarker.commentId,
               is(59822171L));
  }
  ...
  public void pullRequestReviewCommentLink__loadsReviewComment()
      throws Exception {
    LinkParser.ParseResult result = parseLink(
        "https://github.com/slapperwan/gh4a/pull/665#discussion_r136306029");
    PullRequestReviewCommentLoadTask loadTask = assertThatLoadTaskIs(
        result.loadTask, PullRequestReviewCommentLoadTask.class);
    assertThat("User name is incorrect", loadTask.mRepoOwner, is("slapperwan"));
    assertThat("Repo name is incorrect", loadTask.mRepoName, is("gh4a"));
    assertThat("Pull request number is incorrect", loadTask.mPullRequestNumber,
               is(665));
  ...
  public void pullRequestReviewDiffLink__loadsReviewDiff() throws Exception {
    LinkParser.ParseResult result =
        parseLink("https://github.com/slapperwan/gh4a/pull/665"
                  + "#discussion-diff-136304421R590");
    PullRequestReviewDiffLoadTask loadTask = assertThatLoadTaskIs(
        result.loadTask, PullRequestReviewDiffLoadTask.class);
    assertThat("User name is incorrect", loadTask.mRepoOwner, is("slapperwan"));
    assertThat("Repo name is incorrect", loadTask.mRepoName, is("gh4a"));
    assertThat("Pull request number is incorrect", loadTask.mPullRequestNumber,
               is(665));
    assertThat("Diff id is missing", loadTask.mDiffId, is(notNullValue()));
    assertThat("Comment id is incorrect", loadTask.mDiffId.fileHash,
               is("136304421"));
  ...
  public void pullRequestDiffCommentLink__loadsReviewDiff() throws Exception {
    LinkParser.ParseResult result = parseLink(
        "https://github.com/slapperwan/gh4a/pull/665/files#r136306029");
    PullRequestDiffCommentLoadTask loadTask = assertThatLoadTaskIs(
        result.loadTask, PullRequestDiffCommentLoadTask.class);
    assertThat("User name is incorrect", loadTask.mRepoOwner, is("slapperwan"));
    assertThat("Repo name is incorrect", loadTask.mRepoName, is("gh4a"));
    assertThat("Pull request number is incorrect", loadTask.mPullRequestNumber,
               is(665));
    assertThat("Page is incorrect", loadTask.mPage,
               is(PullRequestActivity.PAGE_FILES));
    assertThat("Comment marker is missing", loadTask.mMarker,
               is(notNullValue()));
    assertThat("Comment id is incorrect", loadTask.mMarker.commentId,
  ...
  public void commitLink__opensCommitActivity() throws Exception {
    ...
    assertThat("Commit sha is incorrect", extras.getString("sha"),
               is("commitSha"));
    assertThat("Comment marker is set", extras.getParcelable("initial_comment"),
               is(nullValue()));
  }
  ...
  public void commitLink_withCommentMarker__opensCommitActivity()
      throws Exception {
    LinkParser.ParseResult result = parseLink(
        "https://github.com/slapperwan/gh4a/commit/commitSha#commitcomment-12");
  ...
  public void commitsLink__handlesRefAndPath_andRedirectsToCommitsPage()
      throws Exception {
    LinkParser.ParseResult result =
        parseLink("https://github.com/slapperwan/gh4a/commits");
    RefPathDisambiguationTask loadTask =
        assertThatLoadTaskIs(result.loadTask, RefPathDisambiguationTask.class);
    assertThat("User name is incorrect", loadTask.mRepoOwner, is("slapperwan"));
    assertThat("Repo name is incorrect", loadTask.mRepoName, is("gh4a"));
    assertThat("Ref and path is not empty", loadTask.mRefAndPath,
               isEmptyString());
  ...
  @Test
  public void
  commitsLink_withBranch__handlesRefAndPath_andRedirectsToCommitsPage()
      throws Exception {
    LinkParser.ParseResult result =
  ...
  @Test
  public void
  commitsLink_withRefsHeads__handlesRefAndPath_andRedirectsToCommitsPage()
      throws Exception {
    LinkParser.ParseResult result = parseLink(
        "https://github.com/slapperwan/gh4a/commits/refs/heads/master");
    RefPathDisambiguationTask loadTask =
        assertThatLoadTaskIs(result.loadTask, RefPathDisambiguationTask.class);
    assertThat("User name is incorrect", loadTask.mRepoOwner, is("slapperwan"));
    assertThat("Repo name is incorrect", loadTask.mRepoName, is("gh4a"));
  ...
  public void treeLink__handlesRefAndPath_andRedirectsToFilesPage()
      throws Exception {
    LinkParser.ParseResult result =
        parseLink("https://github.com/slapperwan/gh4a/tree");
    RefPathDisambiguationTask loadTask =
        assertThatLoadTaskIs(result.loadTask, RefPathDisambiguationTask.class);
    assertThat("User name is incorrect", loadTask.mRepoOwner, is("slapperwan"));
    assertThat("Repo name is incorrect", loadTask.mRepoName, is("gh4a"));
  ...
  public void treeLink_withBranch__handlesRefAndPath_andRedirectsToFilesPage()
      throws Exception {
    LinkParser.ParseResult result =
        parseLink("https://github.com/slapperwan/gh4a/tree/master");
    RefPathDisambiguationTask loadTask =
        assertThatLoadTaskIs(result.loadTask, RefPathDisambiguationTask.class);
    assertThat("User name is incorrect", loadTask.mRepoOwner, is("slapperwan"));
    assertThat("Repo name is incorrect", loadTask.mRepoName, is("gh4a"));
  ...
  @Test
  public void
  treeLink_withRefsHeads__handlesRefAndPath_andRedirectsToFilesPage()
      throws Exception {
    LinkParser.ParseResult result =
  ...
  public void blobLink__handlesRefAndPath_andRedirectsToFileViewer()
    ...
    assertThat("User name is incorrect", loadTask.mRepoOwner, is("slapperwan"));
    assertThat("Repo name is incorrect", loadTask.mRepoName, is("gh4a"));
    assertThat("Ref and path is incorrect", loadTask.mRefAndPath,
               is("master/README.md"));
    assertThat("Page is set", loadTask.mInitialPage, is(-1));
    assertThat("Fragment is set", loadTask.mFragment, is(nullValue()));
    assertThat("Does not go to file viewer", loadTask.mGoToFileViewer,
               is(true));
  }

  @Test
  public void
  blobLink_withLineMarker__handlesRefAndPath_andRedirectsToFileViewer()
      throws Exception {
    LinkParser.ParseResult result = parseLink(
        "https://github.com/slapperwan/gh4a/blob/master/build.gradle#L10");
    RefPathDisambiguationTask loadTask =
        assertThatLoadTaskIs(result.loadTask, RefPathDisambiguationTask.class);
    assertThat("User name is incorrect", loadTask.mRepoOwner, is("slapperwan"));
    assertThat("Repo name is incorrect", loadTask.mRepoName, is("gh4a"));
    assertThat("Ref and path is incorrect", loadTask.mRefAndPath,
               is("master/build.gradle"));
    assertThat("Page is set", loadTask.mInitialPage, is(-1));
  ...
  public void blobLink_withoutBranchAndPath__opensBrowser() throws Exception {
    assertRedirectsToBrowser(
        parseLink("https://github.com/slapperwan/gh4a/blob"));
  }
  ...
  public void compareLink_withoutRefs__opensBrowser() throws Exception {
    LinkParser.ParseResult result = (parseLink(
        "https://github.com/slapperwan/gh4a/compare/v4.2.0...v4.2.1"));
  ...
  public void compareLink_withIncompleteRefs__opensBrowser() throws Exception {
    assertRedirectsToBrowser(
        parseLink("https://github.com/slapperwan/gh4a/compare/v4.2.0..."));
  }

  @Test
  public void unknownRepositoryLink__opensBrowser() throws Exception {
    assertRedirectsToBrowser(
        parseLink("https://github.com/slapperwan/gh4a/unknown"));
  }
  ...
  private static void assertRedirectsTo(final LinkParser.ParseResult result,
                                        final Class<?> cls) {
    assertThat("Parse result must not be null to redirect to activity", result,
               is(notNullValue()));
    assertThat("Load task must be null to redirect to activity",
               result.loadTask, is(nullValue()));
    assertThat("Target intent is missing", result.intent, is(notNullValue()));
    assertThat("Target intent is incorrect",
               result.intent.getComponent().getClassName(), is(cls.getName()));
  }

  private static void
  assertRedirectsToBrowser(final LinkParser.ParseResult result) {
    assertThat("Parse result does not redirect to browser (must be null)",
               result, is(nullValue()));
  }

  private static <T extends UrlLoadTask>
      T assertThatLoadTaskIs(final UrlLoadTask loadTask, final Class<T> cls) {
