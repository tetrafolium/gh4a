...
public class RepositoryIssueAdapter extends IssueAdapter {
  public RepositoryIssueAdapter(final Context context) { super(context); }
  ...
  public void onBindViewHolder(final ViewHolder holder, final Issue issue) {
    ...
    holder.tvNumber.setText(mContext.getString(
        R.string.repo_issue_on, issue.number(), urlPart[4], urlPart[5]));
  }
}
