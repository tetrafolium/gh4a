...
public class ReleaseAssetAdapter
    extends RootAdapter<ReleaseAsset, ReleaseAssetAdapter.ViewHolder> {
  public ReleaseAssetAdapter(final Context context) { super(context); }
  ...
  public void onBindViewHolder(final ViewHolder holder,
    ...
    holder.tvCreatedAt.setText(mContext.getString(
        R.string.download_created,
