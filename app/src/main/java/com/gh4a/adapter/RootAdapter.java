...
public abstract class RootAdapter<T, VH extends RecyclerView.ViewHolder>
  ...
  public interface OnItemClickListener<T> { void onItemClick(T item); }
  public interface OnScrolledToFooterListener { void onScrolledToFooter(); }
  ...
  public void setFooterView(final View footerView,
                            final OnScrolledToFooterListener footerListener) {
  ...
  public void setOnItemClickListener(final OnItemClickListener<T> listener) {
    if (mHolderCreated) {
      throw new IllegalStateException(
          "Must not set item click listener after views are bound");
    }
  ...
  public void setContextMenuSupported(final boolean supported) {
    if (mHolderCreated) {
      throw new IllegalStateException(
          "Must not set context menu state after views are bound");
    }
  ...
  public int getItemCount() {
    return mObjects.size() + (mHeaderView != null ? 1 : 0) +
  ...
  public T getItem(final int position) { return mObjects.get(position); }
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup parent,
    ...
    default:
      RecyclerView.ViewHolder holder =
          onCreateViewHolder(mInflater, parent, viewType);
  ...
  protected int getItemViewType(final T item) { return VIEW_TYPE_ITEM; }
  ...
  public boolean isCardStyle() { return false; }

  private static class HeaderViewHolder extends RecyclerView.ViewHolder {
    public HeaderViewHolder(final View v) { super(v); }
  }
  private static class FooterViewHolder extends RecyclerView.ViewHolder {
    public FooterViewHolder(final View v) { super(v); }
  }
}
