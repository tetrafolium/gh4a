...
public class MilestoneAdapter
    extends RootAdapter<Milestone, MilestoneAdapter.ViewHolder> {
  ...
  public MilestoneAdapter(final Context context) {
    super(context);
    mTextColorPrimary =
        UiUtils.resolveColor(context, android.R.attr.textColorPrimary);
    mTextColorSecondary =
  ...
  public void onBindViewHolder(final ViewHolder holder,
    ...
    holder.tvOpen.setText(mContext.getString(
        R.string.issue_milestone_open_issues, milestone.openIssues()));
    holder.tvClosed.setText(mContext.getString(
        R.string.issue_milestone_closed_issues, milestone.closedIssues()));
