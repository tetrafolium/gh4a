...
public class ContributorAdapter
    extends RootAdapter<User, ContributorAdapter.ViewHolder> {
  public ContributorAdapter(final Context context) { super(context); }
  ...
  public void onBindViewHolder(final ViewHolder holder,
    ...
    holder.tvTitle.setText(
        StringUtils.formatName(contributor.login(), contributor.name()));
    holder.tvExtra.setText(mContext.getResources().getQuantityString(
        R.plurals.contributor_extra_data, contributor.contributions(),
