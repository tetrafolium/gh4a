...
class ReviewViewHolder
    extends TimelineItemAdapter
                .TimelineItemViewHolder<TimelineItem.TimelineReview>
  ...
  public ReviewViewHolder(final View itemView,
    ...
    mPopupMenu.getMenuInflater().inflate(R.menu.review_menu,
                                         mPopupMenu.getMenu());
  ...
  private void formatTitle(final Review review) {
    ...
    SpannableStringBuilder text =
        StringUtils.applyBoldTags(textBase, mMessageView.getTypefaceValue());

    CharSequence time = review.submittedAt() != null
                            ? StringUtils.formatRelativeTime(
                                  mContext, review.submittedAt(), true)
                            : "";
  ...
  public void onClick(final View v) {
    ...
    case R.id.btn_show_details: {
      ...
      mContext.startActivity(ReviewActivity.makeIntent(
          mContext, mRepoOwner, mRepoName, mIssueNumber, review, null));
      break;
    }
    case R.id.iv_menu:
      mPopupMenu.show();
    ...
    case R.id.review_file_details: {
      ...
      mContext.startActivity(ReviewActivity.makeIntent(
          mContext, mRepoOwner, mRepoName, mIssueNumber, review,
          new IntentUtils.InitialCommentMarker(commentId)));
      break;
    }
    }
  }
  ...
  private static class FileDetails {
    ...
    public FileDetails(final View row, final boolean isOutdated,
                       final int count) {
      this.row = row;
