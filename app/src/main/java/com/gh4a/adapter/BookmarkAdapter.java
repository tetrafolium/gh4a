...
public class BookmarkAdapter
    extends RecyclerView.Adapter<BookmarkAdapter.ViewHolder>
  ...
  public BookmarkAdapter(final Context context,
                         final OnItemInteractListener listener) {
    super();
  ...
  public long getItemId(final int position) {
    return moveCursorToPosition(position) ? mCursor.getLong(mIdColumnIndex)
                                          : -1;
  }
  ...
  public void onItemSwiped(final RecyclerView.ViewHolder viewHolder) {
    ...
    Uri uri =
        ContentUris.withAppendedId(BookmarksProvider.Columns.CONTENT_URI, id);
    context.getContentResolver().delete(uri, null, null);

    Snackbar
        .make(viewHolder.itemView, R.string.bookmark_removed,
              Snackbar.LENGTH_LONG)
        .setAction(R.string.undo,
                   v
                   -> BookmarksProvider.saveBookmark(context, name, type, url,
                                                     extraData, false))
        .show();
  }
  ...
  static class ViewHolder
    ...
    public ViewHolder(final View view,
                      final OnItemInteractListener itemInteractListener) {
      super(view);
