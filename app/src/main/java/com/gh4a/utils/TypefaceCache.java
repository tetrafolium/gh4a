...
public class TypefaceCache {
  ...
  private static final String[] FONT_FILENAMES = new String[] {
      ...
      "fonts/Roboto-Condensed.ttf", "fonts/Roboto-BoldCondensed.ttf"};

  private static final String[] FONT_FAMILIES = new String[] {
      "sans-serif", "sans-serif-medium",    "sans-serif",
      "sans-serif", "sans-serif-condensed", "sans-serif-condensed"};
  private static final int[] FONT_STYLES =
      new int[] {Typeface.NORMAL, Typeface.NORMAL, Typeface.BOLD,
                 Typeface.ITALIC, Typeface.NORMAL, Typeface.BOLD};
