...
public class StringUtils {
  ...
  formatRelativeTime(final Context context, final Date date,
                     final boolean showDateIfLongAgo) {
  ...
  public static CharSequence formatExactTime(final Context context,
                                             final Date date) {
  ...
  public static void applyBoldTagsAndSetText(final StyleableTextView view,
                                             final String input) {
  ...
  applyBoldTags(final String input, final int baseTypefaceValue) {
  ...
  @Nullable
  public static int[] findMatchingLines(final String input,
                                        final String match) {
  ...
  public static int[] extractDiffHunkLineNumbers(final
                                                 @NonNull String diffHunk) {
  ...
  public static CharSequence formatMention(final Context context,
                                           final User user) {
