...
public class NotificationHandlingService extends IntentService {
  ...
  private static final String ACTION_OPEN_NOTIFICATION =
      "com.gh4a.action.OPEN_NOTIFICATION";
  ...
  public static Intent makeHandleDismissIntent(final Context context,
  ...
  public static Intent makeMarkReposNotificationsAsReadActionIntent(
      final Context context, final int notificationId, final String repoOwner,
  ...
  public NotificationHandlingService() { super("NotificationHandlingService"); }
  ...
  protected void onHandleIntent(final @Nullable Intent intent) {
    ...
    case ACTION_OPEN_NOTIFICATION:
      if (repoOwner != null && repoName != null) {
        Intent notifIntent =
            HomeActivity.makeNotificationsIntent(this, repoOwner, repoName)
  ...
  private void markNotificationAsRead(final String repoOwner,
                                      final String repoName,
    ...
    try {
      ...
      Log.w(Gh4Application.LOG_TAG,
            "Could not mark repo \"" + repoOwner + "/" + repoName +
                "\" as read",
            e);
    }
  }
