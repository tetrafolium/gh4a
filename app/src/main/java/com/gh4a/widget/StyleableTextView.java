...
public class StyleableTextView extends AppCompatTextView {
  ...
  public StyleableTextView(final Context context) { super(context, null); }
  ...
  public int getTypefaceValue() { return mTypefaceValue; }
  ...
  private void initAttributes(final Context context, final AttributeSet attrs,
    ...
    if (attrs != null) {
      TypedArray a = theme.obtainStyledAttributes(attrs, TEXT_APPEARANCE_ATTRS,
                                                  defStyle, 0);
      int ap = a.getResourceId(0, -1);
      if (ap != -1) {
        appearance =
            theme.obtainStyledAttributes(ap, R.styleable.StyleableTextView);
      }
      a.recycle();
    }
    ...
    TypedArray a = theme.obtainStyledAttributes(
        attrs, R.styleable.StyleableTextView, defStyle, 0);
