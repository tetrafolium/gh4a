...
public class MarkdownPreviewWebView
    extends WebView implements NestedScrollingChild2 {
  ...
  public MarkdownPreviewWebView(final Context context) { this(context, null); }
  ...
  public MarkdownPreviewWebView(final Context context, final AttributeSet attrs,
    ...
    mCssTheme = Gh4Application.THEME == R.style.DarkTheme
                    ? WebViewerActivity.DARK_CSS_THEME
                    : WebViewerActivity.LIGHT_CSS_THEME;
  ...
  @Override
  public boolean
  dispatchNestedPreScroll(final int dx, final int dy, final int[] consumed,
                          final int[] offsetInWindow, final int type) {
  ...
  private void setContent(final String content) {
    String html =
        generateMarkdownHtml(StringUtils.toBase64(content), mCssTheme);
    loadDataWithBaseURL("file:///android_asset/", html, null, "utf-8", null);
  }

  private String generateMarkdownHtml(final String base64Data,
  ...
  private static void writeScriptInclude(final StringBuilder builder,
  ...
  private static void writeCssInclude(final StringBuilder builder,
