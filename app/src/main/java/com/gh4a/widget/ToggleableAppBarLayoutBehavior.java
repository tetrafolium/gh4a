...
public class ToggleableAppBarLayoutBehavior extends AppBarLayout.Behavior {
  ...
  public boolean onStartNestedScroll(final @NonNull CoordinatorLayout parent,
                                     final @NonNull AppBarLayout child,
                                     final @NonNull View directTargetChild,
                                     final @NonNull View target,
  ...
  @Override
  public void
  onNestedPreScroll(final @NonNull CoordinatorLayout coordinatorLayout,
                    final @NonNull AppBarLayout child,
                    final @NonNull View target, final int dx, final int dy,
                    final @NonNull int[] consumed, final int type) {
    if (mEnabled) {
  ...
  @Override
  public void onStopNestedScroll(final
                                 @NonNull CoordinatorLayout coordinatorLayout,
                                 final @NonNull AppBarLayout child,
                                 final @NonNull View target, final int type) {
    if (mEnabled) {
