...
public class CommentEditor extends AppCompatMultiAutoCompleteTextView
  ...
  @StringRes private int mCommentEditorHintResId;
  @StringRes private int mLockedHintResId;
  ...
  private void updateLockState() {
    setEnabled(!mLocked);
    if (mLocked) {
      setHint(mLockedHintResId != 0 ? mLockedHintResId
                                    : R.string.comment_editor_locked_hint);
