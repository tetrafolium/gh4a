...
public class ScrollAwareFloatingActionButtonBehavior
    extends FloatingActionButton.Behavior {
  private final FloatingActionButton
      .OnVisibilityChangedListener mVisibilityChangedListener =
  ...
  public ScrollAwareFloatingActionButtonBehavior(final Context context,
  ...
  @Override
  public boolean
  onStartNestedScroll(final @NonNull CoordinatorLayout coordinatorLayout,
                      final @NonNull FloatingActionButton child,
                      final @NonNull View directTargetChild,
                      final @NonNull View target, final int axes,
                      final int type) {
  ...
  public void onNestedScroll(final @NonNull CoordinatorLayout coordinatorLayout,
                             final @NonNull FloatingActionButton child,
                             final @NonNull View target, final int dxConsumed,
