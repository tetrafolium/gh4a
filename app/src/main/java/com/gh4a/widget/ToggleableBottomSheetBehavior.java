...
public ToggleableBottomSheetBehavior(final Context context, final AttributeSet attrs) {
	super(context, attrs);
}
...
public boolean onStartNestedScroll(final CoordinatorLayout coordinatorLayout,
                                   final V child, final View directTargetChild, final View target, final int nestedScrollAxes) {
...
public void onNestedPreScroll(final CoordinatorLayout coordinatorLayout,
                              final V child, final View target, final int dx, final int dy, final int[] consumed) {
	if (mEnabled) {
...
public boolean onNestedPreFling(final CoordinatorLayout coordinatorLayout,
                                final V child, final View target, final float velocityX, final float velocityY) {
