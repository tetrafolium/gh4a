...
public class ReleaseListFragment extends PagedDataBaseFragment<Release>
    implements RootAdapter.OnItemClickListener<Release> {
  private String mUserLogin;
  private String mRepoName;

  public static ReleaseListFragment newInstance(final String owner,
                                                final String repo) {
  ...
  @Override
  protected Single<Response<Page<Release>>>
  ...
  @Override
  protected RootAdapter<Release, ? extends RecyclerView.ViewHolder>
  onCreateAdapter() {
  ...
  public void onItemClick(final Release release) {
    startActivity(ReleaseInfoActivity.makeIntent(getActivity(), mUserLogin,
                                                 mRepoName, release));
  }
}
