...
public class StarredRepositoryListFragment
  ...
  public void onCreate(final Bundle savedInstanceState) {
    ...
    if (savedInstanceState != null &&
        savedInstanceState.containsKey(STATE_KEY_SORT_ORDER)) {
  ...
  public boolean onOptionsItemSelected(final MenuItem item) {
    String[] sortOrderAndDirection =
        mSortHelper.handleSelectionAndGetSortOrder(item);
  ...
  loadPage(final int page, final boolean bypassCache) {
    final StarringService service =
        ServiceFactory.get(StarringService.class, bypassCache);
