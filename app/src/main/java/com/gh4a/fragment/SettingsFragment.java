...
public class SettingsFragment extends PreferenceFragmentCompat
  ...
  public interface OnStateChangeListener { void onThemeChanged(); }
  ...
  public static final String KEY_NOTIFICATION_INTERVAL =
      "notification_interval";
  private static final String KEY_ABOUT = "about";
  private static final String KEY_OPEN_SOURCE_COMPONENTS =
  ...
  public void onAttach(final Context context) {
    ...
    if (!(context instanceof OnStateChangeListener)) {
      throw new IllegalArgumentException(
          "Activity must implement OnStateChangeListener");
    }
  ...
  public boolean onPreferenceClick(final Preference pref) {
    if (pref == mAboutPref) {
      AboutDialog d =
          new AboutDialog(getActivity(), Gh4Application.get().isAuthorized());
      d.setTitle(getAppName());
      d.show();
      return true;
    } else if (pref == mOpenSourcePref) {
      OpenSourceComponentListDialog d =
          new OpenSourceComponentListDialog(getActivity());
      d.show();
      return true;
    }
    return false;
  ...
  private static class AboutDialog
      extends AppCompatDialog implements View.OnClickListener {
    ...
    public void onClick(final View view) {
      ...
      if (id == R.id.btn_by_email) {
        ...
        sendIntent.putExtra(Intent.EXTRA_EMAIL, new String[] {context.getString(
                                                    R.string.my_email)});
        sendIntent.setType("message/rfc822");

        Intent chooserIntent = Intent.createChooser(
            sendIntent, context.getString(R.string.send_email_title));
        context.startActivity(chooserIntent);
      } else if (id == R.id.btn_by_gh4a) {
        Intent intent = IssueListActivity.makeIntent(
            context, context.getString(R.string.my_username),
  ...
  private static class OpenSourceComponentListDialog extends AlertDialog {
    public OpenSourceComponentListDialog(final Context context) {
      ...
      ListView lv =
          (ListView)inflater.inflate(R.layout.open_source_component_list, null);
  ...
  private static class OpenSourceComponentAdapter extends BaseAdapter {
    ...
    public View getView(final int position, final View convertView,
      ...
      if (convertView == null) {
        convertView = mInflater.inflate(R.layout.open_source_component_item,
                                        parent, false);
      }
