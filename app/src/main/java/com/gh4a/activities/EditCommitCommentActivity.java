...
public class EditCommitCommentActivity extends EditCommentActivity {
  ...
  createComment(final String repoOwner, final String repoName,
    ...
    CreateCommitComment request =
        CreateCommitComment.builder().body(body).build();
