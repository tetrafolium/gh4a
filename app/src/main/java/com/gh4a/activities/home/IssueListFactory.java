...
public class IssueListFactory extends FragmentFactory {
  ...
  private static final int[] TAB_TITLES =
      new int[] {R.string.created, R.string.assigned, R.string.mentioned,
  ...
  public IssueListFactory(final HomeActivity activity, final String userLogin,
                          final boolean pr) {
    super(activity);
    mLogin = userLogin;
  ...
  protected @StringRes int getTitleResId() {
    if (mShowingClosed) {
      return mIsPullRequest ? R.string.pull_requests_closed
                            : R.string.issues_closed;
    } else {
      return mIsPullRequest ? R.string.pull_requests_open
                            : R.string.issues_open;
    }
  }
  ...
  protected Fragment makeFragment(final int position) {
    ...
    final String query =
        String.format(QUERY, mIsPullRequest ? "pr" : "issue",
                      mShowingClosed ? ApiHelpers.IssueState.CLOSED
                                     : ApiHelpers.IssueState.OPEN,
                      action, mLogin);

    return IssueListFragment.newInstance(
        query, mDrawerHelper.getSortMode(), mDrawerHelper.getSortOrder(),
        mShowingClosed ? ApiHelpers.IssueState.CLOSED
                       : ApiHelpers.IssueState.OPEN,
        mIsPullRequest ? R.string.no_pull_requests_found
  ...
  public boolean onCreateOptionsMenu(final Menu menu) {
    int resIdState = mShowingClosed ? R.string.issues_menu_show_open
                                    : R.string.issues_menu_show_closed;
  ...
  private void reloadIssueList() { mActivity.invalidateFragments(); }
  ...
  private void updateHeaderColor() {
    mHeaderColorAttrs = new int[] {mShowingClosed ? R.attr.colorIssueClosed
                                                  : R.attr.colorIssueOpen,
                                   mShowingClosed ? R.attr.colorIssueClosedDark
