...
public abstract class FragmentFactory {
  ...
  protected int[] getToolDrawerMenuResIds() { return null; }

  protected void prepareToolDrawerMenu(final Menu menu) {}

  protected boolean onDrawerItemSelected(final MenuItem item) { return false; }

  protected boolean onCreateOptionsMenu(final Menu menu) { return false; }

  protected boolean onOptionsItemSelected(final MenuItem item) { return false; }
  ...
  protected @IdRes int getInitialToolDrawerSelection() { return 0; }
