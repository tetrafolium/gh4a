...
public class RepositoryFactory extends FragmentFactory {
  private static final int[] TAB_TITLES = new int[] {R.string.my_repositories};

  private final String mUserLogin;
  private final RepositoryListContainerFragment
      .FilterDrawerHelper mFilterDrawerHelper;
  private final RepositoryListContainerFragment
      .SortDrawerHelper mSortDrawerHelper;
  ...
  public RepositoryFactory(final HomeActivity activity, final String userLogin,
  ...
  protected void onSaveInstanceState(final Bundle outState) {
    ...
    if (mFragment != null) {
      mActivity.getSupportFragmentManager().putFragment(
          outState, STATE_KEY_FRAGMENT, mFragment);
    }
  }
  ...
  protected void onRestoreInstanceState(final Bundle state) {
    ...
    mFragment =
        (RepositoryListContainerFragment)mActivity.getSupportFragmentManager()
            .getFragment(state, STATE_KEY_FRAGMENT);
    if (mFragment != null) {
