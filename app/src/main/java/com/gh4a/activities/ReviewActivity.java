...
public class ReviewActivity extends FragmentContainerActivity {
  ...
  makeIntent(final Context context, final String repoOwner,
             final String repoName, final int issueNumber, final Review review,
  ...
  protected Fragment onCreateFragment() {
    return ReviewFragment.newInstance(mRepoOwner, mRepoName, mIssueNumber,
                                      mReview, mInitialComment);
  }

  @Override
  protected Intent navigateUp() {
    return PullRequestActivity.makeIntent(
        this, mRepoOwner, mRepoName, mIssueNumber,
