...
public class UserActivity extends BaseFragmentPagerActivity {
  ...
  public static Intent makeIntent(final Context context, final String login) {
    ...
    return new Intent(context, UserActivity.class).putExtra("login", login);
  }
  ...
  private static final int[] TAB_TITLES =
      new int[] {R.string.about, R.string.user_public_activity};
  ...
  public boolean onOptionsItemSelected(final MenuItem item) {
    ...
    case R.id.share: {
      ...
      int subjectId = StringUtils.isBlank(userName)
                          ? R.string.share_user_subject_loginonly
                          : R.string.share_user_subject;
