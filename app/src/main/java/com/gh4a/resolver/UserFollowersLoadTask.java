...
public class UserFollowersLoadTask extends UserLoadTask {
  @VisibleForTesting protected final boolean mShowFollowers;

  public UserFollowersLoadTask(final FragmentActivity activity,
  ...
  protected Intent getIntent(final User user) {
    ...
    return FollowerFollowingListActivity.makeIntent(mActivity, user.login(),
                                                    mShowFollowers);
  }
}
