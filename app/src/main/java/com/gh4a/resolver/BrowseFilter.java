...
public class BrowseFilter extends AppCompatActivity {
  ...
  makeRedirectionIntent(final Context context, final Uri uri,
  ...
  public void onCreate(final Bundle savedInstanceState) {
    setTheme(Gh4Application.THEME == R.style.DarkTheme
                 ? R.style.TransparentDarkTheme
                 : R.style.TransparentLightTheme);
    ...
    LinkParser.ParseResult result =
        LinkParser.parseUri(this, uri, initialComment);
    if (result == null) {
