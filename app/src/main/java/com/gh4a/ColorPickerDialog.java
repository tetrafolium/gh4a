...
public class ColorPickerDialog extends AlertDialog {
  ...
  public ColorPickerDialog(final Context context, final String color,
    ...
    setButton(
        BUTTON_POSITIVE, context.getString(R.string.ok), (dialog, which) -> {
          if (mColorChangedListener != null) {
            int colorValue = mColorPicker.getColor();
            String color1 =
                String.format(Locale.US, "%02x%02x%02x", Color.red(colorValue),
