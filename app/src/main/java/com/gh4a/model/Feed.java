...
public class Feed {
  ...
  @Path(value = "link") @Attribute(name = "href") private String link;

  @Nullable @Element(name = "title", required = false) private String title;
  ...
  @Path(value = "thumbnail") @Attribute(name = "url") private String avatarUrl;

  @Nullable @Element(name = "updated", required = false) private Date updated;
